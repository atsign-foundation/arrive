...
import 'package:atsign_location_app/plugins/at_location_flutter/map_content/flutter_map/src/gestures/latlng_tween.dart';
...
abstract class MapGestureMixin extends State<FlutterMap>
  ...
  void handleScaleUpdate(ScaleUpdateDetails details) {
    ...
    setState(() {
      ...
      // TODO: Added it to restrict zoom out
      var newZoom = map.zoom;
      if (!((map.zoom <= 1) &&
          (_getZoomForScale(_mapZoomStart, details.scale) <= 1))) {
