...
import 'package:atsign_location_app/plugins/at_location_flutter/map_content/flutter_map_marker_cluster/src/marker_cluster_layer.dart';
...
class MarkerClusterPlugin extends MapPlugin {
  ...
  Widget createLayer(
    ...
    return MarkerClusterLayer(options, mapState, stream, key);
  }
